...
- **Spec Location**: Where your spec files live (usually `./.auto-codex/specs/{spec-name}/`)
...
SPEC_DIR="./.auto-codex/specs/YOUR-SPEC-NAME"  # Replace with actual path from step 2
...
```bash
git add .
git commit -m "auto-codex: Complete [subtask-id] - [subtask description]
...
git commit -m "auto-codex: Update progress"
...
Total phases: [N]
Total subtasks: [N]
Branch: auto-codex/[feature-name]
