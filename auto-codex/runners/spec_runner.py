...
# Add auto-codex to path (parent of runners/)
...
dev_env_file = Path(__file__).parent.parent.parent / "dev" / "auto-codex" / ".env"
if env_file.exists():
...
Examples:
  ...
  python runners/spec_runner.py --interactive
    ...
    # Find project root (look for auto-codex folder)
