...
export const createIdeationAPI = (): IdeationAPI => ({
  ...
  getIdeation: (
    ...
    invokeIpcResult(IPC_CHANNELS.IDEATION_GET, projectId),
  ...
  stopIdeation: (projectId: string): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.IDEATION_STOP, projectId),
  ...
  convertIdeaToTask: (
    ...
    invokeIpcResult(IPC_CHANNELS.IDEATION_CONVERT_TO_TASK, projectId, ideaId),

  dismissIdea: (projectId: string, ideaId: string): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.IDEATION_DISMISS, projectId, ideaId),

  dismissAllIdeas: (projectId: string): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.IDEATION_DISMISS_ALL, projectId),

  archiveIdea: (projectId: string, ideaId: string): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.IDEATION_ARCHIVE, projectId, ideaId),

  deleteIdea: (projectId: string, ideaId: string): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.IDEATION_DELETE, projectId, ideaId),

  deleteMultipleIdeas: (
    projectId: string,
    ideaIds: string[],
  ): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.IDEATION_DELETE_MULTIPLE, projectId, ideaIds),
