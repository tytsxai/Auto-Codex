...
export const createInsightsAPI = (): InsightsAPI => ({
  ...
  getInsightsSession: (
    ...
    invokeIpcResult(IPC_CHANNELS.INSIGHTS_GET_SESSION, projectId),
  ...
  clearInsightsSession: (projectId: string): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.INSIGHTS_CLEAR_SESSION, projectId),
  ...
  listInsightsSessions: (
    ...
    invokeIpcResult(IPC_CHANNELS.INSIGHTS_LIST_SESSIONS, projectId),

  newInsightsSession: (
    projectId: string,
  ): Promise<IPCResult<InsightsSession>> =>
    invokeIpcResult(IPC_CHANNELS.INSIGHTS_NEW_SESSION, projectId),

  switchInsightsSession: (
    projectId: string,
    sessionId: string,
  ): Promise<IPCResult<InsightsSession | null>> =>
    invokeIpcResult(IPC_CHANNELS.INSIGHTS_SWITCH_SESSION, projectId, sessionId),

  deleteInsightsSession: (
    projectId: string,
    sessionId: string,
  ): Promise<IPCResult> =>
    invokeIpcResult(IPC_CHANNELS.INSIGHTS_DELETE_SESSION, projectId, sessionId),
