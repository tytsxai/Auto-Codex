    ...
    <Card className="p-4">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between text-sm mb-1">
          ...
          <span>
            {completedCount}/{features.length} 个功能
          </span>
        </div>
      ...
      {phase.milestones.length > 0 && (
        <div className="mb-4">
          <h4 className="text-sm font-medium mb-2">里程碑</h4>
      ...
      {/* 功能 */}
      <div>
        <h4 className="text-sm font-medium mb-2">功能（{features.length}）</h4>
