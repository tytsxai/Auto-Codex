  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange} className="h-full flex flex-col">
      <TabsList className="shrink-0 mx-4 mt-4">
        ...
        <TabsTrigger value="phases">阶段</TabsTrigger>
        <TabsTrigger value="features">全部功能</TabsTrigger>
        <TabsTrigger value="priorities">按优先级</TabsTrigger>
      </TabsList>
            ...
            return (
              <Card key={priority} className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-muted-foreground">{features.length} 个功能</span>
                </div>
